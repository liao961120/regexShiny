This is an R package that wraps around [AdamSpannbauer/r_regex_tester_app](https://github.com/AdamSpannbauer/r_regex_tester_app) to make it easier to launch the shiny app locally.
